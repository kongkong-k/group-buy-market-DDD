package com.qcby.test.domain.tag;

import com.qcby.domain.tag.service.TagService;
...
public class ITagServiceTest {
    ...
    public void test_get_tag_bitmap() {
        ...
        // 是否存在
        log.info("kongkong 存在，预期结果为 true，测试结果:{}", bitSet.get(redisService.getIndexFromUserId("kongkong")));
        log.info("kongbai 不存在，预期结果为 false，测试结果:{}", bitSet.get(redisService.getIndexFromUserId("kongbai")));
    }
